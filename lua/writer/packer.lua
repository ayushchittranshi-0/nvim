...
packer.init({
  ...
  snapshot_path = packer.util.join_paths(vim.fn.stdpath('cache'), 'writer', 'packer.nvim'), -- Default save directory for snapshots
  package_root  = packer.util.join_paths(vim.fn.stdpath('data'), 'writer', 'site', 'pack'),
  compile_path  = packer.util.join_paths(vim.fn.stdpath('config'), 'writer', 'plugin', 'packer_compiled.lua'),
